...
The reason that your product was not their best fit is not only caused by missing feature. You can have all the features the users need and still have a high churn. What you should look for instead is how exactly you are solving the user's problem.
...
But if your vision of your product is exactly about solving your customers problem, then focus on exactly that. Instead of thinking what your product needs think about your customer. What do they need, how do you solve their problem.
...
This is the time when your customer needs you the most. Make sure that you do not leave them alone with your product. Explain them why you came up with this solution. Educate them. Teach them how to use your product properly and ensure that the new way to tackle their problems does not take any more effort than before.
...
Features are, however, the result of this process. At one point your product can be identified by certain features. Your customer will give names to parts of your product names and they become your product's features. You can then use them target new customers, to explain them what you offer and what problem you can solve.
